...
Para poder simular conjuntos de datos a partir de la red asia, se ha utilizado la función rbn. La función rbn implementa el muestreo lógico aleatorio y permite fijar el número de muestras que queremos generar. En este caso se han generado dos muestras, una con 200 instancias y otra con 5000 instancias.
...
Si nos fijamos en las diferencias visuales..
